...
[bastionhost]
bastion-host ansible_host=${yandex_compute_instance.bastion-host.network_interface.0.nat_ip_address} ansible_ssh_user=alex
...
ansible_ssh_common_args='-o ProxyCommand="ssh -W %h:%p alex@${yandex_compute_instance.bastion-host.network_interface.0.nat_ip_address}"'
